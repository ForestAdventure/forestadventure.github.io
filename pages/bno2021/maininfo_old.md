...
permalink: /bno2021-maininfo-old/
regulations: true
---
...
* Дистанция В1 — выбор, необходимо взять все КП, предварительно 20 - 25 км по прямым;
* Дистанция В2 — выбор, необходимо взять 50% любых КП из показанных на карте, примерно 10 км;
* Дистанция В3 — выбор, необходимо взять 25% любых КП из показанных на карте, примерно 5 км;
* Дистанция ЗН — заданное направление, предварительно 14 - 16 км по прямым.
