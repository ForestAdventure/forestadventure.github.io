...
На электричке с Павелецкого вокзала до станции Акри ([расписание](https://rasp.yandex.ru/search/?fromId=c213&fromName=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&toId=c34180&toName=%D0%90%D0%BA%D1%80%D0%B8&when=11+%D0%BD%D0%BE%D1%8F%D0%B1%D1%80%D1%8F)).
...
* **Дистанция В1** — выбор, необходимо взять все **45 КП**, **минимум 19 км по прямым**;
...
Для дистанций выбора 15 контрольных пунктов будет установлено на дополнительной карте в масштабе 1:10000 с сечением рельефа 5 метров.
Использовать дополнительную карту понадобиться только участникам В1.
...
Образцы дополнительной карты

{% include aligner.html images="assets/img/2023/map-bno-example4.png,assets/img/2023/map-bno-example5.png" column=2 %}
...
Местность достаточно сухая, можно преодолеть дистанцию не замочив ног.
