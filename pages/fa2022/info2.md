...
- <span style="background-color: #FFFF00">Рогейн на моноколёсах 3 часа, экспериментальный формат (без награждения).</span>
...
Формат листа — A3+, матовая ламинация с двух сторон.
</span>
