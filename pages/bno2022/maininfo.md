...
Точные координаты точки старта будут опубликованы позднее.
...
Но стартующим после 23:00 нужно учитывать время закрытия финиша 05:00.
...
Если участник использует чип Clever Timing System, его необходимо очистить перед стартом на станции очистки.
...
Заявки принимаются на странице заявки <http://orgeo.ru/event/bno2022>
**до 21:00 11 ноября (пятница)**.
...
| Взнос участника&nbsp;| Оплата до 23:55 6.11&nbsp;| Оплата до 23:55 10.11&nbsp; | Оплата после 10.11 или на месте старта |
|--------------------|-----|-----|-----|
